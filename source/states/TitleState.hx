...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		Devs = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('The-DevsShit1'));
		Devs.visible = false;
		...
		Devs2 = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('The-DevsShit2'));
		Devs2.visible = false;
		Devs2.setGraphicSize(Std.int(Devs2.width * 0.8));
		Devs2.updateHitbox();
		Devs2.screenCenter(X);
		Devs2.antialiasing = ClientPrefs.data.antialiasing;
	...
	override function beatHit()
	{
		...
		if(!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 2:
					createCoolText(['KadeDev'], 40);
					addMoreText('Banbuds', 40);
					addMoreText('Cval', 40);
					addMoreText('Rozebud', 40);
					Devs.visible = true
				case 3:
				Devs.visible = false;
				deleteCoolText();
				case 4:
					createCoolText(['With Help From'], 40);
					addMoreText('Moro', 40);
					addMoreText('Yinyang', 40);
					addMoreText('Jads', 40);
					Devs2.visible = true;
				case 5:
					deleteCoolText()
					Devs2.visible = false;
				case 6:
					createCoolText(['newgrounds'], -40);
				case 8:
					addMoreText('is pog', -40);
					ngSpr.visible = true;
				case 9:
					deleteCoolText();
					ngSpr.visible = false;
